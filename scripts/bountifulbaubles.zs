...
[<rustic:cloudsbluff>, <artifacts:shiny_red_balloon>, <rustic:cloudsbluff>], 
[null, <bountifulbaubles:spectralsilt>, null]]);
...
[<endreborn:item_shard_obsidian>, <artifacts:obsidian_skull>, <endreborn:item_shard_obsidian>], 
...
[<ore:ingotElectrum>, <artifacts:lucky_horseshoe>, <ore:ingotElectrum>],
...
mods.betterwithaddons.Infuser.addShaped(<artifacts:fire_gauntlet>,[
[<bountifulbaubles:spectralsilt>, <artifacts:magma_stone>, <bountifulbaubles:spectralsilt>],
[<bountifulbaubles:spectralsilt>, <artifacts:mechanical_glove>, <bountifulbaubles:spectralsilt>],
[null, <contenttweaker:fire_rune>.anyDamage().transformDamage(), null]], 32);

// Ultimate Pendant

recipes.remove(<artifacts:ultimate_pendant>);

mods.betterwithaddons.Infuser.addShaped(<artifacts:ultimate_pendant>,[
[<bountifulbaubles:spectralsilt>, <artifacts:thorn_pendant>, <bountifulbaubles:spectralsilt>],
[<artifacts:shock_pendant>, <contenttweaker:magic_orb>, <artifacts:flame_pendant>],
[null, <contenttweaker:balance_rune>.anyDamage().transformDamage(), null]], 32);