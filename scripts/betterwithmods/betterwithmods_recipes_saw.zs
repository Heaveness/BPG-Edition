...
Chopping.addRecipe("axe_firwood_bark",<betterwithmods:bark:2>*4,<traverse:fir_log>, true);
...
mods.betterwithmods.Saw.add(<traverse:fir_log>,[<traverse:fir_planks>*5,<betterwithmods:bark:2>*3,<pyrotech:r	ock:7>*2]);
