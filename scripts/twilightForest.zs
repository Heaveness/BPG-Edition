...
recipes.addShaped(<twilightforest:maze_map_empty>, [
   [null, null, null],
   [<wards:enchanted_paper>, <twilightforest:maze_map_focus>, <antiqueatlas:empty_antique_atlas>], 
   [null, <contenttweaker:knowledge_rune>.anyDamage().transformDamage(), null]]);

recipes.addShaped(<twilightforest:magic_map_empty>, [
   [null, null, null],
   [<wards:enchanted_paper>, <twilightforest:magic_map_focus>, <antiqueatlas:empty_antique_atlas>], 
   [null, <contenttweaker:knowledge_rune>.anyDamage().transformDamage(), null]]);
